...
export class Fuse extends Component {
  constructor({ reference, value, xy }: Passive_Initializer = {}) {
    ...
    super("Device:Fuse_Small", reference, value, "Fuse:Fuse_0603_1608Metric", xy);
  }
}
...
export class Inductor extends Component {
  constructor({ reference, value, xy }: Passive_Initializer = {}) {
    ...
    super("Device:L_Small", reference, value, "Inductor_SMD:L_0603_1608Metric", xy);
  }
}
...
export class Diode extends Component {
  constructor({ reference, value, xy }: Passive_Initializer = {}) {
    ...
    super("Device:D_Small", reference, value, "Diode_SMD:D_0603_1608Metric", xy);
  }
}
...
export class LED extends Component {
  constructor({ reference, value, xy }: Passive_Initializer = {}) {
    reference = D_Counter.reference(reference);
    super("Device:LED_Small", reference, value, "LED_SMD:LED_0603_1608Metric", xy);
  }
}
...
export class Resistor extends Component {
  ...
  constructor({ reference, value, wattage, xy }: Resistor_Initializer = {}) {
    ...
    super("Device:R_Small", reference, value, "Resistor_SMD:R_0603_1608Metric", xy);
...
export class Capacitor extends Component {
  ...
  constructor({ reference, value, voltage, xy }: Capacitor_Initializer = {}) {
    ...
    super("Device:C_Small", reference, value, "Capacitor_SMD:C_0603_1608Metric", xy);
